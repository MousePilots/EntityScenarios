 ...
 * @author Roy Cleven
 */
public final class IdentifiableToIdentifiableToIdentifiableJavaUtilMapAttributeUpdate<I extends Serializable, VE extends Serializable, K, V> extends IdentifiableJavaUtilMapAttributeUpdate<I, VE, K, V> {
