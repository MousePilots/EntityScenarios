...
public abstract class Container<T, MT extends ManagedTypeES<T>, A extends AttributeES> extends HasTypeAndAttribute<MT, A> {
     ...
     protected static final TypeVisitor<HasValue, Object> MAP_KEY_COPIER = new TypeVisitor<HasValue, Object>() {
          ...
          public HasValue visit(BasicTypeES t, Object key) {
               if(key==null){
                    ...
                    BasicTypeESImpl basicTypeES = (BasicTypeESImpl) t;
                    return basicTypeES.wrap(key);
               }
          }
          ...
          public HasValue visit(EmbeddableTypeES t, Object key) {
               if(key==null){
                    ...
                    EmbeddableTypeESImpl embeddableTypeES = (EmbeddableTypeESImpl) t;
      ...
      * @param type
      * @param attribute
      * @param mapKey use if and only if the container attribute is a
     ...
     /**
      * Finds the managed container
      *
      * @param entityManager
      * @param typeToClientIdToGeneratedId an optional mapping from
      * {@link IdentifiableTypeES} &rarr; client-{@link Id} &rarr;
      * server-{@link Id}
      * @return the contained entity or embeddable
      */
     public abstract T find(EntityManager entityManager, Map<IdentifiableTypeES, Map<Serializable, Serializable>> typeToClientIdToGeneratedId);
