...
public final class EmbeddableContainer<E> extends Container<E,EmbeddableTypeES<E>,AttributeES< ? super E,?>> {
    ...
    /**
     * Finds the managed embeddable container modeled by {@code this}
     * @param entityManager
     * @param typeToClientIdToGeneratedId
     * @return 
     */
    @Override
    public E find(EntityManager entityManager, Map<IdentifiableTypeES, Map<Serializable, Serializable>> typeToClientIdToGeneratedId)
    {
        ...
        Object managedInstance = currentContainer.find(entityManager, typeToClientIdToGeneratedId);
        do{
            EmbeddableContainer nextContainer = (EmbeddableContainer) i.next();
