...
/**
 * Locates the managed equivalent of a detached embeddable target of an association with a known and managed source.
 * 
 */
public class EmbeddableLocator {
    ...
    private Object locate(Object managedContainer) throws IllegalStateException {
        final AttributeES<?,? extends Collection> containerAttribute = container.getAttribute();
        final Collection embeddables = containerAttribute.getJavaMember().get(managedContainer);
    ...
    private final AttributeVisitor<Object, Object> attributeVisitor = new AttributeVisitor<Object, Object>() {
        ...
        public Object visit(MapAttributeES containerAttribute, Object managedOwner){
            final Map mapAttributeValue = containerAttribute.getJavaMember().get(managedOwner);
