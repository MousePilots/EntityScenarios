...
import org.mousepilots.es.core.command.EmbeddableTypeCommand;
...
public final class CreateEmbeddable<T> extends Create<T,EmbeddableTypeES<T>> implements EmbeddableTypeCommand<T>{
     ...
     public CreateEmbeddable(EntityManagerESImpl entityManager,EmbeddableTypeES<T> typeDescriptor) {
