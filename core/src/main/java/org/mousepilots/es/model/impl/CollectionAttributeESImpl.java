...
public class CollectionAttributeESImpl<T, E>
    ...
    public CollectionAttributeESImpl(TypeES<E> elementType,
            BindableType bindableType, Class<E> bindableJavaType, String name,
            int ordinal, Class<Collection<E>> javaType,
        ...
        super(CollectionType.COLLECTION, elementType, bindableType,
                bindableJavaType, name, ordinal, javaType, persistentAttributeType,
                javaMember, readOnly, true, association, declaringType,
