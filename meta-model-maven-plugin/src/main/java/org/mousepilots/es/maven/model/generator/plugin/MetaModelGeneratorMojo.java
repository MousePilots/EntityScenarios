...
public class MetaModelGeneratorMojo extends AbstractMojo {
    ...
    private enum SubPackage {
        ...
        /**
         * The subpackage in which the {@link MetaModel} implementation is
         * written
         */
        META_MODEL(""),
        /**
        ...
        /**
         * The subpackage in which {@link AttributeES} implementations are
         * written
         */
        ATTRIBUTE("attribute");
        ...
        /**
         * @return the name of the subpackage, relative to
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            final TypeGenerator generator = new TypeGenerator();
